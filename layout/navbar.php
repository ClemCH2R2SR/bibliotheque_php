<nav class="bg-white dark:bg-gray-900 fixed w-full z-20 top-0  left-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <a href="http://localhost:81/index.php" class="flex items-center">
      <img src="../img/logo_bibliotheque.png" class="h-20 mr-5" alt="Logo">
      <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Bibliotheque</span>
  </a>
  <div class="flex md:order-2">
      <a href="/file_inclusion/login_and_subscription.php">
      <button type="button" class="text-white bg-green-500 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">S'inscrire / Se connecter
      </button>
      </a>
